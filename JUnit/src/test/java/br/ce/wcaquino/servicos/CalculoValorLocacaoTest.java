...
@RunWith(Parameterized.class) //É necessário indicar que a classe é parametrizavel
public class CalculoValorLocacaoTest {
	...
	@Parameters(name="{2}") // este (name="{2}") é só p/ deixar o OUTPUT mais legível. Opcional
	...
	@Test
	public void deveCalcularValorLocacaoConsiderandoDescontos() throws FilmeSemEstoqueException, LocadoraException, Exception{
		//cenario
